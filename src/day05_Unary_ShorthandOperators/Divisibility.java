...
public class Divisibility {
    public static void main (String[] args) {
        ...
        //if the number  can be divided by 2 without any reminder,

        boolean divisibleBy3 = number % 3 == 0 ;
        //if the number  can be divided by 3 without any reminder,

        boolean divisibleBy5 = number % 5 == 0;
        //if the number  can be divided by 5 without any reminder,
        ...
        */
        ...
        System.out.println(result1 + "\n"+result2 + "n"+ result3); // concatenation==>returns string

        String finalResult = result1 +"n"+ result2+ "n" +result3;
